...
!
CONTAINS
  FUNCTION FLL_GETNDATA_R0(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(R0)
!
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'R',0_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_R1(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(R1)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'R',1_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_R2(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(R2)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'R',2_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
...
!  DOUBLE
!
  FUNCTION FLL_GETNDATA_D0(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(R0)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'D',0_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_D1(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(R1)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'D',1_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_D2(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(R2)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'D',2_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
...
!  INTEGER
!
  FUNCTION FLL_GETNDATA_I0(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(I0)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'I',0_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_I1(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(I1)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'I',1_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_I2(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(I2)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'I',2_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
...
!  LONG INTEGER
!
  FUNCTION FLL_GETNDATA_L0(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(I0)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'L',0_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_L1(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(I1)
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'L',1_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
  ...
  FUNCTION FLL_GETNDATA_L2(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(I2)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'L',2_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'S',0_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
...
FUNCTION FLL_GETNDATA_S1(PNODE,NAME,NUMBER,FPAR,ACTION) RESULT(STRING)
!
! Description: returns single real data of the node
!
! 
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'S',1_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)
...
!
   ...
   PFIND => FLL_LOCATE(PNODE,NAME,'S',2_LINT,NUMBER,.FALSE.,FPAR,LOC_ACT)

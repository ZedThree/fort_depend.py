...
!
CONTAINS
  FUNCTION FLL_WRITE(PNODE,FILE,IOUNIT,FMT,FPAR) RESULT(OK)
!
...
!   WRITE  LINKED LIST
!
    CALL FLL_WRITE_LIST(PNODE,IOUNIT,FMT_LOC,FPAR)
  ...
  END FUNCTION FLL_WRITE
   ...
   SUBROUTINE FLL_WRITE_LIST(PNODE,IOUNIT,FMT,FPAR)
!
...
!
   IF(ASSOCIATED(PCHILD))CALL FLL_WRITE_RECURSIVE_NODE(PCHILD,IOUNIT,POS,FMT,FPAR)
...
!
  RECURSIVE SUBROUTINE FLL_WRITE_RECURSIVE_NODE(PNODE,IOUNIT,POS,FMT,FPAR)
!
...
!
    DO WHILE(ASSOCIATED(PCURR))
       ...
       IF(ASSOCIATED(PCHILD))THEN
         CALL FLL_WRITE_RECURSIVE_NODE(PCHILD,IOUNIT,POS,FMT,FPAR)
       END IF

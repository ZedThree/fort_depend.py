...
!
CONTAINS
  FUNCTION FLL_WRITE(PNODE,FILE,IOUNIT,FMT,FPAR, ACTION) RESULT(OK)
!
...
!   WRITE  LINKED LIST
!
    CALL FLL_WRITE_LIST(PNODE,IOUNIT,FMT_LOC,FPAR,LOC_ACT)
  ...
  END FUNCTION FLL_WRITE
   ...
   SUBROUTINE FLL_WRITE_LIST(PNODE,IOUNIT,FMT,FPAR,LOC_ACT)
!
...
!
   IF(ASSOCIATED(PCHILD))CALL FLL_WRITE_RECURSIVE_NODE(PCHILD,IOUNIT,POS,FMT,FPAR,LOC_ACT)
...
!
  RECURSIVE SUBROUTINE FLL_WRITE_RECURSIVE_NODE(PNODE,IOUNIT,POS,FMT,FPAR,LOC_ACT)
!
...
!
    DO WHILE(ASSOCIATED(PCURR))
       ...
       IF(ASSOCIATED(PCHILD))THEN
         CALL FLL_WRITE_RECURSIVE_NODE(PCHILD,IOUNIT,POS,FMT,FPAR,LOC_ACT)
       END IF

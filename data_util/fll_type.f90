...
!
  ...
  INTEGER, PARAMETER  :: LICOMPIL =  LINT
  INTEGER, PARAMETER  :: SICOMPIL =  SINT
  ...
  INTEGER,  PARAMETER :: STRING_LENGHT = 24
!
...
!
  TYPE DNODE
    ...
    INTEGER(LICOMPIL) :: NDIM  = 0, NSIZE = 0 
    INTEGER(LICOMPIL) :: POS  = 0, LENGTH = 0 

...
CONTAINS
   ...
   RECURSIVE FUNCTION LL_NNODES(PNODE,NAME,LTYPE,RECURSE,FPAR) RESULT(NUMBER)
...
!
     IF(RECURSE .AND. ASSOCIATED(PCURR%PCHILD))THEN
       PCHLD => PCURR%PCHILD
       NUMBER = NUMBER + LL_NNODES(PCHLD,NAME,LTYPE,RECURSE,FPAR)
...
!
   ...
   RETURN
   END FUNCTION LL_NNODES


END MODULE LL_NNODES_M
